Comprises of a simple user interface and intermediate computer artificial intelligence such that the user is not capable of winning against the computer, in a fair game of the classic Tic Tac Toe.
# Notes 
